      ...
      <div className="mx-auto max-w-7xl px-6 py-12 grid gap-10 md:grid-cols-4">
        ...
        <div className="md:col-span-2 flex flex-col gap-4">
          <div className="flex items-center gap-4">
            <BrandLogo className="w-14 h-14 shadow-md" />
            <div>
  ...
  <ul className="grid grid-cols-2 gap-3">
    {[
      ...
      <li key={link.name}>
        <a
          href={link.href}
          className="flex items-center gap-2 p-3 rounded-xl bg-white shadow-md hover:bg-emerald-50 hover:translate-y-[-2px] hover:shadow-lg transition-all duration-300 group"
        >
        ...
        <div>
          ...
          <div className="mt-6 flex items-center gap-3">
            <a
              aria-label="Twitter"
              href="#"
              className="p-3 rounded-full bg-emerald-100 text-emerald-700 hover:bg-emerald-200 hover:text-emerald-900 transition-colors shadow-md"
            >
      ...
      <div className="border-t border-slate-200">
        <div className="mx-auto max-w-7xl px-6 py-4 flex flex-col md:flex-row items-center justify-between text-xs text-slate-500 gap-2">
